...
export default function Intro(profile) {
    const imageUrl = `${
        profile.profile.picture.url.startsWith('/')
    ...
    return (
        <section
            className="px-0 py-2 md:py-5 m-2 md:m-5 text-theme-text-2 
          ...
          lg:rounded-full lg:rounded-r-lg lg:relative"
            >
                <img
                    ...
                    src={imageUrl}
                    className={
                        'w-36 sm:w-72 object-left-top md:object-cover lg:object-center p-0 m-0 hover:shadow-medium transition-shadow duration-200'
                    }
                />
            </div>
            ...
            <div className="w-full p-1 sm:p-0">
                <h1 className="leading-relaxed lg:pr-10">
                    “ Développeur Freelance Data spécialisé également en
                    développement Front-End, je peux vous accompagner sur des
                    projets de développement Web mais aussi sur des missions
                    orientées DATA. ”
                </h1>
            </div>
        </section>
