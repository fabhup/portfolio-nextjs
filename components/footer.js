        ...
        text-xs xs:text-sm  sm:text-lg">
          ...
          <div>
            <div className="flex flex-row justify-center 
              ...
              />
              <span className="block my-2 md:mx-2">fabien.hupel@gmail.com</span>
            </div>
            ...
            <FontAwesomeIcon 
              ...
              className="m-1 w-6 sm:w-7 sm:w-7"
              />
            <span className="block my-2 md:mx-2">(+33) 6 84 09 33 67 </span>
            </div>
          </div>
