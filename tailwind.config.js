    ...
    theme: {
        extend: {
            ...
            colors: {
                ...
                cyan: '#79FFE1',
                gray: {
                    darkest: 'var(--bluegrey-darkest)',
                    dark: 'var(--bluegrey-dark)',
                    DEFAULT: 'var(--bluegrey)',
                    light: 'var(--bluegrey-light)',
                    lightest: 'var(--bluegrey-lightest)',
                },
                primary: {
                    DEFAULT: 'var(--primary)',
            ...
            outline: {
                ...
                card: '2px solid var(--primary-lightest)',
            },
            width: {
                'full-vw': '100vw',
            },
            height: {
                'full-40': 'calc(100% - 10rem)',
                'full-60': 'calc(100% - 15rem)',
                'fullvh-40': 'calc(100vh - 10rem)',
            },
            minHeight: {
